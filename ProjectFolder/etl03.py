# SUBMITTED TO UDACITY DE, WORKS BEST WHEN USED FROM A SPARK CLUSTER CREATED IN THE AWS CONSOLE.
...
def process_log_data(spark, input_data, output_data):
    ...
    songplays_table = songplays_table.join(time_table, songplays_table.start_time == time_table.start_time, how="inner")\
        .select("songplay_id", songplays_table.start_time.alias("start_time"), "user_id", "level", \
                "song_id", "artist_id", "session_id", "location", "user_agent", time_table.year.alias("year"), time_table.month.alias("month"))
